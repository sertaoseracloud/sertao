...
<execution_context>
@C:/Repo/blog_sertao/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @C:/Repo/blog_sertao/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
