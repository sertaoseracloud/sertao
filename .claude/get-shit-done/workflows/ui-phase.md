...
```markdown
Read C:/Repo/blog_sertao/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Repo/blog_sertao/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Repo/blog_sertao/.claude/agents/gsd-ui-checker.md for instructions.
