...
```
Task(
  prompt="Read C:/Repo/blog_sertao/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Repo/blog_sertao/.claude/get-shit-done/templates/VALIDATION.md`
