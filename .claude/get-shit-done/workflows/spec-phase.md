...
```bash
INIT=$(node "C:/Repo/blog_sertao/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Repo/blog_sertao/.claude/get-shit-done/templates/spec.md.
