...
Reference full template: `C:/Repo/blog_sertao/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Repo/blog_sertao/.claude/get-shit-done/templates/state.md`.
