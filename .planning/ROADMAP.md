...
- [x] Code blocks têm: copy button (CopyCode.astro, Copiar/✓/Erro, 1.5s reset) — done in 04-03; filename label, line highlight, mobile scroll from 04-02 transformers
...
- [x] 06-02-PLAN.md — Search component + Header wiring + PostLayout CommentsEmbed + tag chips
- [x] 06-03-PLAN.md — /tags/ index page + /tags/[tag] dynamic route + homepage span→a upgrade
